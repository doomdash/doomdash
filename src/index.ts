...
const createWindow = (): void => {
	...
	downloader.register(mainWindow);
	// TODO register UZDoom downloader or something with os case logic.
	// Want to make downloader OS agnostic
	// downloadUZdoom, downloadFreeDoom => file downloader, unzipper
